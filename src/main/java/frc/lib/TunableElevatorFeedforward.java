 ...
 */
public class TunableElevatorFeedforward implements ProtobufSerializable, StructSerializable {
    ...
    /**
     * Creates a new TunableElevatorFeedforward with the specified gains and period.
     *
     ...
     */
    public TunableElevatorFeedforward(double ks, double kg, double kv, double ka, double dtSeconds) {
        this.ks = ks;
        this.kg = kg;
        this.kv = kv;
        this.ka = ka;
    ...
    /**
     * Creates a new TunableElevatorFeedforward with the specified gains. The period is defaulted to 20 ms.
     *
     * @param ks The static gain in volts.
     * @param kg The gravity gain in volts.
     * @param kv The velocity gain in V/(m/s).
     ...
     * @throws IllegalArgumentException for ka &lt; zero.
     */
    public TunableElevatorFeedforward(double ks, double kg, double kv, double ka) {
        this(ks, kg, kv, ka, 0.020);
    }

    /**
     * Creates a new TunableElevatorFeedforward with the specified gains. Acceleration gain is defaulted to
     ...
     * @throws IllegalArgumentException for kv &lt; zero.
     */
    public TunableElevatorFeedforward(double ks, double kg, double kv) {
        this(ks, kg, kv, 0);
    }
    ...
    /** TunableElevatorFeedforward struct for serialization. */
